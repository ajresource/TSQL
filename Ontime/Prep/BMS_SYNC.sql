...
select @ProjectNo=ZZ.ProjectNo,@BudgetOPITdays=ZZ.BudgetOPITdays,@ProjectTitle=ZZ.ProjectTitle from zz_BMS_TASKS ZZ where ID=@ID
...
set Custom_249=LEFT(@Custom_249,50)
where TaskID=@p1
*/
select @p1
