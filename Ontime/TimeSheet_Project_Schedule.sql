...
/****** Object:  Job [Synd_TimeSheet_Projects1]    Script Date: 06/21/2013 15:39:49 ******/
...
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 06/21/2013 15:39:49 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [isipl_Project_Sync]    Script Date: 06/21/2013 15:39:50 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'isipl_Project_Sync', 
		@step_id=1, 
		...
		@command=N'/DTS "\MSDB\isipl_Projects" /SERVER ISAUIT07 /X86  /CHECKPOINTING OFF /REPORTING E', 
		@database_name=N'master', 
		@output_file_name=N'C:\AJ\Log.txt', 
		@flags=2
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
