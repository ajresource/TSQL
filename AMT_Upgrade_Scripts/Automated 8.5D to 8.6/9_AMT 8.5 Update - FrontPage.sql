Update AMT_VARIABLE SET Database_Patch_Ver = '8.5.25.5'
GO
...
insert AMT_TYPED_VARIABLE ( Value_Name,Varchar_Value )  select 'Front_Page_HTML','<html>
<head>
<style>
<!-- p.MsoNormal
	{margin:0cm;
...
<body lang=EN-US>
<p class=MsoNormal><span style=''font-size:76.0pt''>&nbsp;</span></p>
...
<p class=MsoNormal align=center style=''text-align:center''><b><span style=''font-size:12.0pt''>AMT 8.5 (Update 5)</span></b></p>
...
<p class=MsoNormal><span style=''font-size:8.0pt;color:#999999''><a href="http://www.isipl.com"><b>www.isipl.com</b></a></span></p>
<p class=MsoNormal><span style=''font-size:8.0pt''>&nbsp;</span></p>
<p class=MsoNormal><span style=''font-size:8.0pt;color:#999999''>AMT is protected by copyright and international treaties. Unauthorised reproduction or distribution of this program, or any portion of it, may 

result in civil and criminal penalties.</span></p>
</body>
</html>'
