...
sqlcmd -S %Server% -U %User% -P %Pass%  -d %DB% -i 0_AMT_8_5_Patch_DataLoading.sql
sqlcmd -S %Server% -U %User% -P %Pass%  -d %DB% -i 1_AMT_8_5_Patch_Database_Structure.sql
sqlcmd -S %Server% -U %User% -P %Pass%  -d %DB% -i 4_AMT_8_5_Patch_Function.sql
sqlcmd -S %Server% -U %User% -P %Pass%  -d %DB% -i 5_AMT_8_5_Patch_Views.sql
sqlcmd -S %Server% -U %User% -P %Pass%  -d %DB% -i 6_AMT_8_5_Patch_SP.sql
sqlcmd -S %Server% -U %User% -P %Pass%  -d %DB% -i "9_AMT 8.5 Update - FrontPage.sql"
sqlcmd -S %Server% -U %User% -P %Pass%  -d %DB% -i AMT_8_5_FILTER_CONFIG_Data_Load_1_Report.sql
sqlcmd -S %Server% -U %User% -P %Pass%  -d %DB% -i AMT_FILTER_CONFIG_Data_Load_2_SearchCtl.sql
sqlcmd -S %Server% -U %User% -P %Pass%  -d %DB% -i AMT_FILTER_CONFIG_Data_Load_6_QuickMenu.sql

sqlcmd -S %Server% -U %User% -P %Pass%  -d %DB% -i AmtDatabase_8_5_25_U5_to_8_5_47.sql
sqlcmd -S %Server% -U %User% -P %Pass%  -d %DB% -iAmtDatabase_8_5_25_U5_to_8_5_47_Data_Fixes.sql
