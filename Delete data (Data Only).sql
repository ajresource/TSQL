...
delete   FROM  dbo.REP_DAILY_USAGE
...
DELETE FROM EQP_SCHED_HRS_DAY
delete from tblEqpPlans
DELETE FROM CM_TRANSLATION_LEVEL
delete from CM_TRANSLATION
DELETE FROM EMI_FOLLOW_UP
DELETE FROM EMI_WORK_ORDER
...
DELETE FROM 		OVERHEAD_ACTUAL_COST
